...
#ifdef NAND_DEFBUG
#define DEBUG_YA5(i)
#define DEBUG_YA6(i) printf("%s %s() lines(%d) flag:%d\n",__FILE__,__func__,__LINE__, i)
#else
#define DEBUG_YA5(i)
#define DEBUG_YA6(i)
#endif
...
#define init_waitqueue_head(wait)
...
#define wake_up(...)
#define BUG(...)
#define schedule() //idle//rt_thread_idle_gethandler//idle
#define jiffies sys_tick_get()//rt_tick_get()//ticks
...
#define likely(x) (x)
#define unlikely(x) (x)
//#define kmalloc(x,...) kmalloc(x,0,0)//rt_malloc(x)//#define kmalloc(x,...) malloc(x)
//#define kfree(x,...) kfree(x,0)//rt_free(x)
